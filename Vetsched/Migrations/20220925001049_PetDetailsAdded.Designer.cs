...
namespace Vetsched.Migrations
{
    ...
    [Migration("20220925001049_PetDetailsAdded")]
    partial class PetDetailsAdded
    {
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "service_category", new[] { "default", "doctor" });
            ...
            modelBuilder.Entity("Vetsched.Data.Entities.Pet", b =>
                {
                    ...
                    b.Property<JsonElement?>("Allergies")
                        .HasColumnType("jsonb")
                    ...
                    b.Property<string>("DueVaccine")
                        .HasColumnType("text")
                        .HasColumnName("due_vaccine");

                    b.Property<string>("LastVistDescription")
                        .HasColumnType("text")
                        .HasColumnName("last_vist_description");

                    b.Property<JsonElement?>("Medications")
                        .HasColumnType("jsonb")
                        .HasColumnName("medications");

                    b.Property<bool>("Microchiped")
                        .HasColumnType("boolean")
                        .HasColumnName("microchiped");
                    ...
                    b.Property<string>("VaccineRecieved")
                        .HasColumnType("text")
                        .HasColumnName("vaccine_recieved");
            ...
            modelBuilder.Entity("Vetsched.Data.Entities.ServiceProvider", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Vetsched.Data.Entities.ServiceProvider", b =>
                {
                    b.HasOne("Vetsched.Data.Entities.UserProfile", "Provider")
                        .WithMany("ProvidedServices")
                        .HasForeignKey("ProviderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Vetsched.Data.Entities.Service", "Service")
                        .WithMany("Providers")
